...
class Unload_DB(QThread):
    ...
    def unload_db(self, file_infos):
        ...
        if version[3:] != '0':
            ...
            tab_all, view_all, program_all, trigger_all, default_all, user_all, prog_all = init.init_all_2008(f,
                                                                                                              tab_data_22,
                                                                                                              tab_data_29,
                                                                                                              tab_data_05,
            ...
            self.LUP.emit("\t初始化 用户表 ...")
            tab_all, view_all, program_all, trigger_all, default_all, user_all, prog_all = init.init_all_2000(f,
                                                                                                              tab_data_1,
                                                                                                              tab_data_2,
                                                                                                              tab_data_3)
