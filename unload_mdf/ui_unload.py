...
class Ui_MainWindow(object):
    ...
    def item_find(self):
        ...
        items = self.treeWidget1.findItems(sss, QtCore.Qt.MatchStartsWith | QtCore.Qt.MatchRecursive,
                                           0)  # tree的查找  MatchStartsWith MatchExactly MatchRegExp  MatchRecursive
