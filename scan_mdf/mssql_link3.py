            ...
            if v_1[ii].page_no_1 == v_1[i].page_no_2 + 1 and v_1[i].file_no_1 == v_1[ii].file_no_1:
                ...
                if (page_1 + 1) % 8 != 0:
                    ...
                    if data_1_1[0] == data_2_1[0] and data_1_2[0] == data_2_2[0]:
                        gin_id += 1
                        cursor.execute("update link_2 set g2_id=%d,g2in_id=%d where offset_1=%d " % (
                        g_id, gin_id, v_1[ii].offset_1))
                        v_1[ii].page_sum = 5
                else:
                    gin_id += 1
                    cursor.execute(
                        "update link_2 set g2_id=%d,g2in_id=%d where offset_1=%d " % (g_id, gin_id, v_1[ii].offset_1))
                    v_1[ii].page_sum = 5
...
def link_3_1(db_name):
    ...
    cursor.execute(
        "create table link_3 as select b.g2_id,(a.page_no_2-b.page_no_1+1) page_sum,b.offset_1,a.offset_2,b.page_no_1,a.page_no_2,a.file_no_1 from aa1 a,aa2 b where a.g2_id=b.g2_id;")
